...
function init_gear_sets()
	...
	sets.precast.FC = { --caps at 80% -- You're nowhere near that >.>
		ammo="Incantor Stone",
    	head="Haruspex Hat",
	...
	sets.precast.FC.Regen = set_combine(sets.precast.FC, {-- I have added duration to ensure it's effect even with QC. ca 3minutes
		...
		sub="Culminus",
		head="Telchine Cap", --8
		body="Piety Briault",--Potency +36%
		hands="Ebers Mitts",--Duration +22 (beats anything)
		legs="Theophany Pantaloons",--18 seconds extra.
		--feet="Telchine Pigaches",--potency +2
		feet="Telchine Pigaches",--9
		})

	sets.precast.FC.StatusRemoval = set_combine(sets.precast.FC['Healing Magic'],{
		legs="Ebers Pantaloons",--precast 10%
	})
	...
	sets.midcast.CureSolace = { --when afflatus solace is on --I 61%, II 7%
		...
		body="Ebers Bliaud",						-- II 3%	I  5%
		hands="Telchine gloves",				--			I 10%
		--lring="Ephedra Ring",						--					Skill + 7
		--rring="Ephedra Ring",						--					Skill + 7
		legs="Ebers Pantaloons",													--6% Cure Amount returned to MP
		feet="Piety duckbills",					--			I  8%
		back="Solemnity Cape",					--			I  7%
		--body="Ebers Bliaud",--solace 14
	...
	sets.midcast.Cursna = { --this should be cursna and healing magic skill, skill 576
		--main="Yagrush",
		sub="Culminus",
		head="Ebers Cap",--divine veil+22%,skill+24
		--neck="Incanter's torque",--skill+10
		body="Ebers Bliaud",--skill+24
		...
		legs="Theophany Pantaloons",-- Cursna +15
	...
	sets.midcast['Enhancing Magic'] = { --541 skill
		...
		legs="Piety Pantaloons", --skill 22 / bar 30
		feet="Ebers Duckbills", --skill 25
	...
	sets.midcast.Protectra = set_combine(sets.midcast.EnhDuration,{lring="Sheltered Ring",feet="Piety duckbills"})
	sets.midcast.Shellra = set_combine(sets.midcast.EnhDuration,{lring="Sheltered Ring",legs="Piety Pantaloons"})
