...
hud_transparency = 160 -- a value of 0 (invisible) to 255 (no transparency at all)
debug_gs1 = false
usemephitas = false
...
function user_setup()
    ...
    send_command('alias bu input /ma stoneskin;wait 7.5;input /ma aquaveil;wait 6.0;input /ma refresh;wait 5.5;input /ma regen')
...
function init_gear_sets()
    ...
    sets.precast.JA['Elemental Siphon'] = {
		...
		body={ name="Telchine Chas.", augments={'"Elemental Siphon"+25','INT+8',}},
...
include('SMN-lib.lua') -- Leave this line to include all the gearswap functionality --
