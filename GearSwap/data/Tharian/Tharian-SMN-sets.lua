...
bpmagicstaff = "Grioavolr" -- augments={'Blood Pact Dmg.+8','Pet: Mag. Acc.+25','Pet: "Mag.Atk.Bns."+22',}}
bpmagicaccstaff = "Grioavolr" -- augments={'Blood Pact Dmg.+8','Pet: INT+14','Pet: Mag. Acc.+30','Pet: "Mag.Atk.Bns."+10',}}
smnskillstaff = "Espiritus" --, augments={'Summoning magic skill +15','Pet: Mag. Acc.+30','System: 2 ID: 153 Val: 3',}}
avatarattackstaff = "Espiritus"
refreshstaff = "Grioavolr" --, augments={'"Occult Acumen"+3','Accuracy+9','"Refresh"+1','Magic Damage +8',}}
gada="Gada" --, augments={'Enh. Mag. eff. dur. +5','Mag. Acc.+4',}}

--[#2 Augmented Items & JSE Cape ]--
conveyance = "Conveyance Cape" --, augments={'Summoning magic skill +4','Blood Pact Dmg.+4','Blood Pact ab. del. II -3',}}
conveyanceskill = "Conveyance Cape" --, augments={'Summoning magic skill +5','Blood Pact Dmg.+2',}}
campestres_magic = "Campestres's Cape" --, augments={'Pet: M.Acc.+20 Pet: M.Dmg.+20','Mag. Acc+20 /Mag. Dmg.+20','Pet: Magic Damage+10','Pet: Haste+10',}}
campestres_att="Campestres's Cape" --, augments={'Pet: Acc.+20 Pet: R.Acc.+20 Pet: Atk.+20 Pet: R.Atk.+20','Accuracy+20 Attack+20','Accuracy+10','Pet: Haste+10',}}
campestres_idle="Campestres's Cape" --, augments={'MP+60','Eva.+20 /Mag. Eva.+20','Pet: "Regen"+10',}}
campestres_fc="Campestres's Cape" --, augments={'MP+60','MP+18','"Fast Cast"+10',}}


sets.apogee = {
    body = "Apogee Dalmatica", --, augments={'Summoning magic skill +15','Enmity-5','Pet: Damage taken -3%',}},
    hands = "Apogee Mitts", --, augments={'Pet: Mag. Acc.+25','"Blood Pact" ability delay+7','Blood Pact Dmg.+8',}},
    legs="Apogee Slacks", --, augments={'MP+60','Pet: "Mag.Atk.Bns."+30','Blood Pact Dmg.+7',}},
    feet="Apogee Pumps", --, augments={'MP+60','Summoning magic skill +15','Blood Pact Dmg.+7',}},
}
sets.apogee2 = {
...
apogee_crown_phy="Apogee Crown" -- +1", augments={'MP+80','Pet: Attack+35','Blood Pact Dmg.+8',}}
apogee_crown_mag="Apogee Crown" -- +1", augments={'MP+80','Pet: "Mag.Atk.Bns."+35','Blood Pact Dmg.+8',}}

apogee_slacks_phy="Apogee Slacks" -- +1", augments={'Pet: STR+20','Blood Pact Dmg.+14','Pet: "Dbl. Atk."+4',}}
--apogee_slacks_mag={ name="Apogee Slacks", augments={'MP+60','Pet: "Mag.Atk.Bns."+30','Blood Pact Dmg.+7',}}
--apogee_slacks_phy="Apogee Slacks" --, augments={'Pet: STR+15','Blood Pact Dmg.+13','Pet: "Dbl. Atk."+3',}}
apogee_slacks_mag="Apogee Slacks" -- +1", augments={'MP+80','Pet: "Mag.Atk.Bns."+35','Blood Pact Dmg.+8',}}


moonshade="Moonshade Earring" --, augments={'"Mag.Atk.Bns."+4','TP Bonus +250',}}

sets.enticers = {
	--legs={ name="Enticer's Pants", augments={'MP+20','Pet: Mag. Acc.+4',}}
    legs="Enticer's Pants" --, augments={'MP+45','Pet: Accuracy+14 Pet: Rng. Acc.+14','Pet: Mag. Acc.+13','Pet: Damage taken -3%',}},
}
enticers ="Enticer's Pants" --, augments={'MP+45','Pet: Accuracy+14 Pet: Rng. Acc.+14','Pet: Mag. Acc.+13','Pet: Damage taken -3%',}}
...
glyphichorn={ name="Glyphic Horn +1", augments={'Enhances "Astral Flow" effect',}}
...
telch_head="Telchine Cap" --, augments={'"Elemental Siphon"+30','Enh. Mag. eff. dur. +10',}}
telch_body="Telchine Chas."--, augments={'"Elemental Siphon"+30','Enh. Mag. eff. dur. +10',}}
telch_hands="Telchine Gloves"--, augments={'"Elemental Siphon"+30','Enh. Mag. eff. dur. +9',}}
telch_legs="Telchine Braconi"--, augments={'"Elemental Siphon"+30','Enh. Mag. eff. dur. +9',}}
telch_feet="Telchine Pigaches"--, augments={'Enh. Mag. eff. dur. +10',}}

merlinic_head_fc="Merlinic Hood" --, augments={'"Mag.Atk.Bns."+30','"Fast Cast"+6','MND+6','Mag. Acc.+4',}} --14
merlinic_head_mab="Merlinic Hood"--, augments={'Mag. Acc.+23 "Mag.Atk.Bns."+23','Mag. Acc.+12','"Mag.Atk.Bns."+10',}}

merlinic_body_mab=-"Merlinic Jubbah"--, augments={'Mag. Acc.+25 "Mag.Atk.Bns."+25','"Fast Cast"+1','MND+7','Mag. Acc.+10','"Mag.Atk.Bns."+15',}}

merlinic_hands="Merlinic Dastanas"--, augments={'Pet: Mag. Acc.+16 Pet: "Mag.Atk.Bns."+16','Blood Pact Dmg.+9','System: 1 ID: 1792 Val: 8','Pet: Mag. Acc.+7','Pet: "Mag.Atk.Bns."+9',}}
merlinic_hands_fc = "Merlinic Dastanas"--, augments={'"Mag.Atk.Bns."+14','"Fast Cast"+6','INT+10','Mag. Acc.+11',}} --6
merlinic_hands_mab="Merlinic Dastanas" --, augments={'Mag. Acc.+25 "Mag.Atk.Bns."+25','MND+3','Mag. Acc.+11',}}
merlinic_hands_refresh="Merlinic Dastanas"--, augments={'Pet: DEX+14','Pet: Accuracy+17 Pet: Rng. Acc.+17','"Refresh"+2',}}


merlinic_legs_mburst="Merlinic Shalwar"--, augments={'"Snapshot"+1','"Conserve MP"+1','Magic burst mdg.+15%','Accuracy+13 Attack+13','Mag. Acc.+18 "Mag.Atk.Bns."+18',}}--15

merlinic_feet_fc="Merlinic Crackows" --, augments={'Mag. Acc.+18 "Mag.Atk.Bns."+18','"Fast Cast"+6','INT+8',}}--11
merlinic_feet_refresh="Merlinic Crackows"--, augments={'STR+10','Pet: "Mag.Atk.Bns."+23','"Refresh"+2','Accuracy+4 Attack+4','Mag. Acc.+9 "Mag.Atk.Bns."+9',}}


amal_head="Amalric Coif"--, augments={'INT+10','Mag. Acc.+20','Enmity-5',}}
amal_hands="Amalric Gages"--, augments={'INT+10','Mag. Acc.+15','"Mag.Atk.Bns."+15',}}
...
sets.precast.WS['Myrkr'] = {
	...
	hands="Lamassu mitts +1",
	legs="Beck. Spats +1",
	feet="Apogee Pumps", --augments={'MP+80','Pet: "Mag.Atk.Bns."+35','Blood Pact Dmg.+8',}},
...
sets.midcast.Cure = {
	main="Serenity",
	head="Vanya hood",--10%
	body="Facio bliaut", --12 --body="Vanya robe",
	hands="Telchine Gloves", --10 --hands="Reveal. Mitts +1",--14%
	legs="Vanya slops",
	feet="Vanya clogs",--5%
