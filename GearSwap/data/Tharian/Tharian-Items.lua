...
gear.odyssean_da_legs = {name="Odyssean Cuisses", augments={'"Dbl.Atk."+4','STR+2','Accuracy+13','Attack+4',}}
...
gear.valorous_da_body = {name="Valorous Mail", augments={'Attack+7','"Dbl.Atk."+4',}}
